// Создание кода T4 для модели "C:\Users\matve\Documents\sharaga\ШАРАГА\Личный хентай\Макаркина Папка с Хентаем\индусТРИАЛ\AutoserviceApp\AutoserviceApp\Autoservice.edmx" включено. 
